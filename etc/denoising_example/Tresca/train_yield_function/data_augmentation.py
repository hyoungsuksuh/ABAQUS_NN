...
# Load raw data
if denoised:
  data = pd.read_csv("../raw_data_"+file_name+"_without_noise.csv")
else:
  data = pd.read_csv("../raw_data_"+file_name+"_with_noise.csv")
...
data = np.hstack((p_level_set, rho_level_set, theta_level_set,             \
...
if denoised:
  output.to_csv("./"+file_name+"_training_data_without_noise.csv", index = False)
else:
  output.to_csv("./"+file_name+"_training_data_with_noise.csv", index = False)